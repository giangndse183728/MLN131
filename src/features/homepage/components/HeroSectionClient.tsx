          ...
          <div className="grid grid-cols-12 gap-6 items-center">
            ...
            <div className="col-span-12 md:col-span-5 xl:col-span-4 text-center md:text-left md:pr-10 relative z-20" ref={textRef}>
              <FadeUp >
                ...
                >
                  <h2 className="font-sub tracking-[0.5em] uppercase text-[#333]/80 text-sm">The MLN131</h2>
                  <motion.div 
              ...
              <FadeUp >
                <h1 className="mb-6 relative">
                  ...
                  <motion.div 
                    className="absolute -right-10 top-1/2 w-14 h-14 border border-[#111]"
                    animate={{ 
                      rotate: [0, 90],
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                  {heroSEOContent.links.map((link, index) => (
                    ...
                    >
                      <Link 
                        href={link.url} 
                        className={`px-8 py-3 ${index === 0 ? 'bg-[#111] text-white hover:bg-red-900' : 'border-2 border-red-900 text-[#111] hover:bg-red-900 hover:text-white'} font-sub text-sm uppercase tracking-widest transition-colors duration-300`}
                      >
                        {link.text}
                      </Link>
                    </motion.div>
                ...
                <div className="flex flex-col items-start gap-4">
                  {featuredItems.map((_, idx) => (
                    ...
                    >
                      ...
                      />
                      <span className={`font-sub text-xs uppercase tracking-wider ${idx === activeIndex ? 'text-[#111]' : 'text-[#111]/40 group-hover:text-[#111]/60'} transition-colors`}>
                        {`0${idx + 1}`}
                      </span>
                    </motion.button>
                  ))}
                      ...
                      >
                        <div className="p-6 pt-3 pb-3">
                          <div className="border-b border-white/20 pb-3 mb-3">
                            <span className="font-sub text-xs uppercase text-white/60 tracking-widest">Câu Chuyện Nổi Bật</span>
                          </div>
          ...
          >
            <div className="flex flex-wrap justify-between items-center">
              <div className="flex items-center">
                ...
                >
                  Biên Niên Sử Chính Trị Việt Nam
                </motion.span>
                <motion.div 
                ...
                />
                <span className="font-sub text-xs uppercase text-[#111]/70 tracking-wide">THÀNH LẬP 2025</span>
              </div>
              ...
              >
                <span className="font-serif text-xs text-[#111]/70 tracking-wider">Khám phá tương lai của dân chủ</span>
              </motion.div>
              
              <div className="flex items-center">
                <span className="font-sub text-xs uppercase text-[#111]/70 tracking-wide mr-4">Tập I</span>
                <motion.div 
